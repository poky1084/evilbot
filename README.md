...
<b>functions:</b> `resetseed('clientseed'), resetstats(), vault(amount), log('text'), start(), stop(), resetAll(), resetChart(), deleteLogs()` <br />

<b>Variables:</b> `win, currentstreak, profit, wagered, balance, previousbet, currentprofit, bets, wins, losses, losestreak, winstreak, sleepfor = 1000` <br />
